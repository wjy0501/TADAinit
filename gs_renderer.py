...
class Renderer:
    ...
    def initialize(self, input=None, num_pts=100000, radius=0.5):
    ...
    def pcb(self):
        ...
        self.skel = Skeleton(apose=True)
        self.skel.load_smplx("/home/jingyiwu/Dream2DGS/smplx_models", gender='neutral')

        points = self.skel.sample_smplx_points(N=100000)
